# 2단계 적재 리포트 (2026-07-12T12:25:26.612187+00:00)
파서: 20970문단 (감사기준 3630 / 회계기준 17163 / 실무지침 177) → 분할 후 20986레코드
para_type 분포: {'결론도출근거': 9155, '적용지침': 4468, '본문': 3922, '적용사례': 1753, '요구사항': 1279, '정의': 280, '부록': 99, '참조': 14}
...
sparse: 어휘집 9,869 토큰, avgdl 77.6711
dense: 외부 임베딩 사용 (--embeddings)
외부 dense 결합: index/embeddings.npy (sha256 ca769e9b6dda…), cid 조인 20986건
── 점검 1~7 (규약 5장) ──
  [PASS] 1 문단 수 포인트 20986 (기대 20986)
  [PASS] 2 seq 연속성(파일 스코프) 이상 []
  [PASS] 3 ID 유일성 복합 20986 / UUID 20986 / 포인트 20986
  [정보] 4 표 표본(사람 육안): KIFRS::1117::BC407, KIFRS::1116::IE2#1, KIFRS::1115::BC510#1, KIFRS::1108::BC62#1, KIFRS::1115::BC510#2
  [PASS] 5 벡터 dense 20986 / sparse 20986 / 이상 0
...
── 스모크 S1~S9 ──
  ...
  [PASS] S8 참조 14건
  [PASS] S9 왕복+본문 전수 20986건 검사, 불일치 0
  [PASS] S10 직조회 KIFRS::1116::BC1 
  [PASS] S11 결론도출근거 DB 9164 = 로컬 9164
...
메타 컬렉션 standards_20250829_bgem3_v3_meta: manifest 1 + vocab 1 + glossary 664 = 666포인트
매니페스트 기록: index/manifest.json (코퍼스 커밋 e0276f7)
