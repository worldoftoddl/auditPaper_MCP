# 2단계 적재 리포트 (2026-07-08T01:01:36.351084+00:00)
파서: 10062문단 (감사기준 3630 / 회계기준 6255 / 실무지침 177) → 분할 후 10063레코드
para_type 분포: {'적용지침': 4468, '본문': 3922, '요구사항': 1279, '정의': 280, '부록': 99, '참조': 14}
...
sparse: 어휘집 4,904 토큰, avgdl 69.5479
dense: 외부 임베딩 사용 (--embeddings)
외부 dense 결합: index/embeddings.npy (sha256 177b5c4c0733…), cid 조인 10063건
── 점검 1~7 (규약 5장) ──
  [PASS] 1 문단 수 포인트 10063 (기대 10063)
  [PASS] 2 seq 연속성 이상 []
  [PASS] 3 ID 유일성 복합 10063 / UUID 10063 / 포인트 10063
  [정보] 4 표 표본(사람 육안): GUIDE::2016-1::19, KSA::315::부록-105, KIFRS::CF::6.42, KSA::ASSR-3000::45, KIFRS::1109::B4.1.13
  [PASS] 5 벡터 dense 10063 / sparse 10063 / 이상 0
  [정보] 6 무마침표 — 코퍼스 검증기 승계 (매니페스트의 커밋 해시로 갈음)
  [PASS] 7 분할 정합 {('240', '부록1'): [(1, 2), (2, 2)]}
  [정보] 8 cross_refs 실재성 — v2 백로그, 보류
── 스모크 S1~S9 ──
  [PASS] S1 라우팅 315 351 = 351
  [PASS] S2 직조회 KIFRS::1115::31 
  [PASS] S3 dense '수행의무의 정의' top5=['KIFRS::1115::정의-수행의무', 'KIFRS::1115::B2', 'KIFRS::1115::B4', 'KIFRS::1115::B3', 'KIFRS::1115::B33']
  [PASS] S4 dense '지배력의 세 가지 요소' top5=['KIFRS::1110::B80', 'KIFRS::1110::8', 'KIFRS::1110::B85', 'KIFRS::1110::B2', 'KIFRS::1110::B7']
  [PASS] S5 하이브리드 '핵심감사사항' top5=['KSA::701::A57', 'KSA::701::A29', 'KSA::701::10', 'KSA::701::16', 'KSA::701::13']
  [PASS] S5' +감사기준 필터 top5=['KSA::701::A57', 'KSA::701::A29', 'KSA::701::10', 'KSA::701::16', 'KSA::701::13']
  [PASS] S6 정의×1200 65건
  [PASS] S7 부록1 재조립 2건 part_no=[1, 2]
  [PASS] S8 참조 14건
  [PASS] S9 왕복+본문 전수 10063건 검사, 불일치 0
── P1~P3 장문 프로브 (기록용: dense 순위 / 하이브리드 순위) ──
  ...
  [기록] P2 '일괄상계약정' → KIFRS::1032::50: dense 1위 / 하이브리드 1위 (하이브리드 top3: ['KIFRS::1032::50', 'KIFRS::1115::17', 'KIFRS::1115::75'])
  [기록] P3 '재고자산 정의' → KIFRS::1002::6: dense 2위 / 하이브리드 5위 (하이브리드 top3: ['KIFRS::1002::9', 'KIFRS::1002::8', 'KIFRS::1002::26'])
메타 컬렉션 standards_20250829_bgem3_meta: manifest 1 + vocab 1 + glossary 664 = 666포인트
매니페스트 기록: index/manifest.json (코퍼스 커밋 6a8c8c9)
